...
with ui.nav_panel("About"):
    ...
    ui.markdown("""
                ...
                * [Floating Catchment Area (FCA)](https://doi.org/10.1111/0033-0124.00210), using 30 and 60 minute thresholds.
                * [Two-Step Floating Catchment Area (2SFCA)](https://doi.org/10.1068/b29120), using 30 and 60 minute thresholds.
                * [Enhanced Two-Step Floating Catchment Area (E2SFCA)](https://doi.org/10.1016/j.healthplace.2009.06.002), using 30 and 60 minute thresholds.
                * [Gaussian Two-Step Floating Catchment Area (G2SFCA)](https://doi.org/10.1080/00045608.2012.657146), using sigma (&sigma;) of 10 and 20
                * [Three-Step Floating Catchment Area (3SFCA)](https://doi.org/10.1080/13658816.2011.624987)
                * [Rational Agent Access Model (RAAM)](https://doi.org/10.1080/24694452.2019.1629870), using tau (&tau;) of 30 and 60.
